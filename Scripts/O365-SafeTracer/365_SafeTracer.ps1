...
<#
    ...
    .EXAMPLE
        ...
        .\365_SafeTracer.ps1 -id 1104 -urllist "http://example.com, https://example.com"
        .\365_SafeTracer.ps1 -urllist "http://example.com, https://example.com" -recipientlist "user1@example.com, user2@example.com, user3@example.com"
